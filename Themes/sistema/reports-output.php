	...
	<?php 			
				switch($tpReports){
					case 1: // Hoje
						...
						$conditions = "saida_cadastro BETWEEN '{$inicial}' AND '{$final}'";
					...
					case 4: // Do ano 
						...
						break;
					default: // Do período 
						$conditions = "saida_cadastro BETWEEN '{$dateInitial}' AND '{$dateFinal}'";
			...
			foreach($Read as $Show):
				...
				$quantity = strip_tags($Show['saida_quantidade_estoque']) . ' ' . strip_tags($Show['saida_medidas']);				
				$quantityStock = strip_tags($Show['saida_quantidade_estoque_atual']) . ' ' . strip_tags($Show['saida_medidas']);
				$register = date('d-m-Y H:i', strtotime($Show['saida_cadastro']));
			?>
		<tr>
			<td>
