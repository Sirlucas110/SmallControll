...
$ReadProd = $pdo->prepare("SELECT a.pedido_id, a.pedido_produto_id, a.pedido_quantidade, b.produto_id, b.produto_quantidade FROM si_pedidos a INNER JOIN si_produtos b ON (b.produto_id = a.pedido_produto_id) WHERE a.pedido_id = :pedido_id");
$ReadProd->bindValue(':pedido_id', $Id);
$ReadProd->execute();
...
$DeleteProd = $pdo->prepare("DELETE FROM " . DB_ORDERS . " WHERE pedido_id = :pedido_id");
$DeleteProd->bindValue(':pedido_id', $Id);
$DeleteProd->execute();
